#!/usr/bin/python3
'''The Rectangle unit tests module.'''
import unittest
...
class TestRectangle(unittest.TestCase):
    '''the tests the Base class.'''

    def setUp(self):
        '''gets module, instantiates class'''
        Base._Base__nb_objects = 0

    def tearDown(self):
        '''Clear after each test_method.'''
        pass

    # ----------------- Tests for #2 ------------------------

    def test_A_class(self):
        '''the Rectangle class type tests.'''
        self.assertEqual(str(Rectangle),
                         "<class 'models.rectangle.Rectangle'>")

    def test_B_inheritance(self):
        '''it tests if Rectangle inherits Base.'''
...
given"
    ...
    def test_D_instantiation_positional(self):
        '''positional instantiation tests.'''
    ...
    def test_E_id_inherited(self):
        '''it tests if id is inherited from Base.'''
        Base._Base__nb_objects = 98
        r = Rectangle(2, 4)
        self.assertEqual(r.id, 99)

    def test_F_properties(self):
        '''the tests property getters/setters.'''
        r = Rectangle(5, 9)
        r.width = 100
        r.height = 101
        r.x = 102
    ...
    def invalid_types(self):
        '''prints tuple of types for validation.'''
    ...
    def test_H_property(self):
        '''property setting/getting Tests.'''
        r = Rectangle(1, 2)
        attributes = ["x", "y", "width", "height"]
        for attribute in attributes:
            n = randrange(10) + 1
    ...
    def test_I_area(self):
        '''the tests area() method compuation.'''
        r = Rectangle(5, 6)
    ...
    def test_J_display_no_args(self):
        '''display() method signature Tests.'''
        r = Rectangle(9, 8)
        with self.assertRaises(TypeError) as e:
            Rectangle.display()
    ...
    def test_J_display_simple(self):
        '''the tests display() method output.'''
        r = Rectangle(1, 1)
        f = io.StringIO()
...
"""
    ...
    def test_K_str_no_args(self):
        '''the tests __str__() method signature.'''
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.__str__()
    ...
    def test_K_str(self):
        '''The tests __str__() method return.'''
        r = Rectangle(5, 2)
    ...
    def test_L_update_no_args(self):
        '''The tests update() method signature.'''
        r = Rectangle(5, 2)
        with self.assertRaises(TypeError) as e:
            Rectangle.update()
    ...
    def test_L_update_args(self):
        '''The tests update() postional args.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_L_update_args_bad(self):
        '''The tests update() positional arg fubars.'''
        r = Rectangle(5, 2)
        d = r.__dict__.copy()
    ...
    def test_M_to_dictionary(self):
        '''the tests to_dictionary() signature:'''
        with self.assertRaises(TypeError) as e:
