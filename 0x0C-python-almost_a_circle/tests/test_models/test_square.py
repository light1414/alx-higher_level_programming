...
class TestSquare(unittest.TestCase):
    ...
    def tearDown(self):
        '''Clears after each test_method.'''
        pass

    # ----------------- Tests for #2 ------------------------

    def test_A_class(self):
        '''The tests Square class type.'''
        self.assertEqual(str(Square),
                         "<class 'models.square.Square'>")

    def test_B_inheritance(self):
        '''it tests if Square inherits Base.'''
...
were given"
    ...
    def test_H_property(self):
        '''The tests property setting/getting.'''
        r = Square(1, 2)
    ...
    def test_I_area_no_args(self):
        '''The tests area() method signature.'''
        r = Square(5)
        with self.assertRaises(TypeError) as e:
            Square.area()
    ...
    def test_J_display_no_args(self):
        '''The tests display() method signature.'''
        r = Square(9)
        with self.assertRaises(TypeError) as e:
            Square.display()
