...
class Rectangle:
    ...
    @property
    def height(self):
        """ The method that returns the value of height
    ...
    def __str__(self):
        """ the method that returns the Rectangle #
    ...
    def __repr__(self):
        """ the method that returns the string represantion of the instance
    ...
    def __del__(self):
        """ Method that prts a message when the instance is deleted
    ...
    def bigger_or_equal(rect_1, rect_2):
        """ The method that returns the bigger Rectangle
